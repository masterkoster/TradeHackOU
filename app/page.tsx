...
export default function Dashboard() {
  return (
    <div className="relative min-h-screen w-full bg-[#f7f7f2] text-black">
      <Header />
        ...
        <section className="grid gap-10 md:grid-cols-[1.2fr_0.8fr] md:items-center">
          <div className="space-y-5">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <button className="rounded-md bg-black px-5 py-2 text-sm font-semibold text-white">
                Open Account
              </button>
              <button className="rounded-md border border-black/15 px-5 py-2 text-sm font-semibold text-black/70">
                View Pricing
              </button>
            </div>
          </div>
